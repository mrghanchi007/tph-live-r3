        ...
        ur: {
          ...
          dosageSection: {
            ...
            steps: [
              {
                stepNumber: '1️⃣',
                title: 'Bustmax XL پاؤڈر کا 1 چائے کا چمچ (≈5g) لیں',
                description: 'ناشتے کے بعد'
              },
              {
                stepNumber: '2️⃣',
                title: 'دوبارہ 1 چائے کا چمچ لیں',
                description: 'رات کے کھانے کے بعد'
              },
              {
                stepNumber: '3️⃣',
                title: 'نیم گرم دودھ یا پانی میں ملائیں',
                description: 'دن میں دو بار'
              },
              {
                stepNumber: '4️⃣',
                title: '30-45 دن تک باقاعدگی سے استعمال کریں',
                description: 'نظر آنے والے نتائج کے لیے'
              }
            ],
            notes: [
              '💡 ہلکی مالش یا ہلکی ورزش قدرتی طور پر نتائج کو بڑھانے میں مدد کرتی ہے۔',
              '⚠️ تیل والی خوراک، سافٹ ڈرنکس، اور رات کے دیر سے کھانے سے پرہیز کریں۔'
            ]
          },
          faqTitle: '❓ اکثر پوچھے جانے والے سوالات',
          faqSubtitle: 'Bustmax XL کے بارے میں جو کچھ آپ کو جاننے کی ضرورت ہے',
          faqs: [
            {
              question: 'سوال 1: Bustmax XL کس لیے استعمال ہوتا ہے؟',
              answer: '➡️ چھاتی کو مضبوط بنانے، شکل بہتر بنانے، اور ہارمونل توازن کے لیے۔'
            },
            {
              question: 'سوال 2: نتائج کب نظر آنا شروع ہوں گے؟',
              answer: '➡️ 2-3 ہفتوں میں آپ کو واضح سختی اور لفٹ محسوس ہوگی۔'
            },
            {
              question: 'سوال 3: کیا یہ تمام خواتین کے لیے محفوظ ہے؟',
              answer: '➡️ 100% جڑی بوٹیوں سے — 18 سال سے زیادہ عمر کی تمام خواتین کے لیے محفوظ۔'
            },
            {
              question: 'سوال 4: کیا اسے دودھ پلانے یا وزن کم ہونے کے بعد استعمال کیا جا سکتا ہے؟',
              answer: '➡️ جی ہاں! مضبوطی اور شکل بحال کرنے کے لیے بہترین۔'
            },
            {
              question: 'سوال 5: کیا یہ سائز بڑھاتا ہے؟',
              answer: '➡️ مضبوطی پر توجہ دیتا ہے، لیکن ہارمونل سپورٹ کے ذریعے بھرپن بڑھاتا ہے۔'
            },
            {
              question: 'سوال 6: کوئی ضمنی اثرات؟',
              answer: '➡️ کوئی نہیں — یہ کیمیکل سے پاک ہے اور صرف قدرتی جڑی بوٹیوں سے بنا ہے۔'
            },
            {
              question: 'سوال 7: اسے کتنے عرصے تک استعمال کرنا چاہیے؟',
              answer: '➡️ نظر آنے والے نتائج کے لیے کم از کم 30-45 دن؛ مکمل کورس کے لیے 90 دن۔'
            },
            {
              question: 'سوال 8: کیا نوجوان یا بڑی عمر کی خواتین اسے استعمال کر سکتی ہیں؟',
              answer: '➡️ جی ہاں، 18+ کے لیے تجویز کیا جاتا ہے اور رجونورتی کے بعد بھی فائدہ مند۔'
            },
            {
              question: 'سوال 9: کیا میں اسے دوسری جڑی بوٹیوں کی مصنوعات کے ساتھ ملا سکتی ہوں؟',
              answer: '➡️ جی ہاں، دیگر پلانر ہربل سپلیمنٹس کے ساتھ استعمال کرنا محفوظ ہے۔'
            }
          ]
        }
      }
